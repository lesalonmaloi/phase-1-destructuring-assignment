...
let newerAnimals = [...newAnimals]
newerAnimals.splice(3,1);
let [blackAndWhite, black, pink] = newerAnimals;
...
let {dontCare1, song2, dontCare2, song4} = nestedMuppet.album.theMuppetMovie;
